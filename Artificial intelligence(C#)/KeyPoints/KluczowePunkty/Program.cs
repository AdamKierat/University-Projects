...
namespace KluczowePunkty
{
    class Program
    {
        ...
        {
            KeyPoints p = new KeyPoints();
            Console.WriteLine("Result will be inside bin folder");
            Console.WriteLine("WORKING...");
            p.AddMask();
            p.PotencialPoints(10000);
        }
    }
    class KeyPoints
    {
        public void AddMask()
        {
            Bitmap btm = new Bitmap(@"..\\orginal.png");
            Bitmap newimage = new Bitmap(btm.Width,btm.Height);
            double[][] filter = new double[3][];
            filter[0] = new double[] { -1, -1, -1 };
            filter[1] = new double[] { -1, 8, -1 };
            filter[2] = new double[] { -1, -1, -1 };
        ...
        {
            Bitmap btm = new Bitmap(@"..\\result.png");
